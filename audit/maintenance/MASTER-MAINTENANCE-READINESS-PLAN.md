...
| 2 | CI أخضر (Typecheck & build + API tests + ESLint) | ✅ | Actions run #10 @ `49bcf62` |
...
|--------|----------------|-----------|--------|
| **هنا (أساسي)** | `origin` → `waelzaid66-max/-BANCO-CA-OOM-` | `main` @ `49bcf62`+ | مزامنة `banco.store-main` عند توفر المسار |
...
- [x] Actions: Typecheck & build + API tests + ESLint = green
